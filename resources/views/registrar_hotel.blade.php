                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                ...
                                <form id="form_registrar_hotel" action="/api/hoteles/registrar">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nit" placeholder="Ingresar NIT">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1">Número de habitaciones</label>
                                        <input type="number" class="form-control" name="numero_habitaciones" placeholder="Ingresar núm. de habitac.">
                                    </div>
                                    <div class="form-group mb-3">
                                        <button type="submit" class="btn btn-primary">Enviar</button>
                                        <small id="mensaje_exito" class="d-none form-text text-success">Hotel registrado con éxito.</small>
                                        <small id="mensaje_error" class="d-none form-text text-danger">Error al registrar hotel.</small>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    $("#form_registrar_hotel").submit(function(e) {
        $("#mensaje_exito").addClass("d-none");
        ...
        $.ajax({
            ...
            {
                $("#mensaje_exito").removeClass("d-none");
            },
